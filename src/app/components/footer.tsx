...
const Footer = () => {
  return (
    <div>
      <footer className="text-gray-900 body-font bg-[#F0F0F0] ">

  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
        
        <span className="ml-3 text-3xl">SHOP.CO</span>
      </a>
    ...
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10 w-[124px] h-[177px] flex flex-col gap-[26px]">
  <li>
  ...
  <li>
    <a className="text-gray-600 hover:text-gray-800">Career</a>
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10 w-[136px] h-[177px] flex flex-col gap-[26px]">
  <li>
  ...
  <li>
    <a className="text-gray-600 hover:text-gray-800">Privacy policy</a>
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10 w-[149px] h-[177px] flex flex-col gap-[26px]">
  <li>
  ...
  <li>
    <a className="text-gray-600 hover:text-gray-800">Development Tutorials</a>
  </li>
  <li>
